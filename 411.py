...
conversion = (1/1.609)*(0.3048)

print("\nThe distance matrix D is:\n")
print(D)

print("\nThe primitive impedance matrix zprim in ohms/1000ft is:\n")
print(zprim*conversion)
...
print("\nThe 'Kron' reduced phase impedance matrix zabc in ohms/1000ft is:\n")
print(zabc*conversion)

print("\nThe sequence impedance matrix z012 in ohms/1000ft is:\n")
print(z012*conversion)