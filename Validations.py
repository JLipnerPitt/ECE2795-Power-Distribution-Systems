...
def CreateProject4():
  ...
  circ.add_geometry("Geometry 1", [0+j*29, 2.5+j*29, 7+j*29, 4+j*25], circ.conductors["336400_26/7_ACSR"], circ.conductors["4/0_6/1_ACSR"], [1, 1, 1])
  circ.add_dline_from_geometry("line1", "bus1", "bus2", "Geometry 1", 0.3787879, True)
  circ.add_dline_from_geometry("line2", "bus3", "bus4", "Geometry 1", 0.4734848, True)
  circ.add_transformer("T1", "bus2", "bus3", 7.20, 4.16, [6000, 6000, 6000], [0.01, 0.01, 0.01], [0.06, 0.06, 0.06])
