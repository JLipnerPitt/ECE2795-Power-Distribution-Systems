...
zabc = zabc*(10000/5280) # converting to ohm/ft and finding the resistance in ohms
...
print("The primitive impedance matrix in ohms is\n")
print("[z] = \n", zprim, "\n")

print("In partitioned form, the submatrices in ohms are\n")
print("[zij] = \n", zij, "\n")
print("[zin] = \n", zin, "\n")
print("[znj] = \n", znj, "\n")
print("[znn] = \n", znn, "\n")
